...
async def FlowDecDeconvolution2D(file_name, effectiveness, isroi, dictRoiPts):
    ...
    bf_cmd = f"sh /app/mainApi/bftools/bfconvert -noflat -separate -tilex 1024 -tiley 1024 -pyramid-scale 2 -pyramid-resolutions 4 -separate -overwrite '{output_path}' '{omePath}'"
    await shell(bf_cmd)  
