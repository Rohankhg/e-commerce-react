...
async def add_image_tiles(
    ...
    for each_file in files:
        ...
        new_file_name = file_name.rsplit(".",1)[0] + ".ome.tiff"
        ...
        if file_name.endswith("jpg|png|jpeg|JPG|PNG"):
            ...
            bf_cmd = f"sh /app/mainApi/bftools/bfconvert -noflat -separate -tilex 1024 -tiley 1024 -pyramid-scale 2 -pyramid-resolutions 4 -separate -overwrite '{input}' '{output}'"
            await shell(bf_cmd)
